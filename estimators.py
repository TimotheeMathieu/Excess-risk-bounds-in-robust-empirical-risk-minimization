...
class classifier(BaseEstimator):
    ...
    def fit(self, x, Y):
        ...
        w = self.w0
        pas = lambda t: self.eta0 / (1 + self.eta0 * self.beta * t) ** self.power
        ...
        for t in range(self.epochs):
            ...
            self.losses += [l]
            # momentum in case there is some trouble to converge
...
class regressor(BaseEstimator):
    ...
    def fit(self, x, Y):
        ...
        for t in range(self.epochs):
            ...
            # momentum in case you have problems to converge
            v = self.momentum * v + (1 - self.momentum) * pas(t) * grad
            w = w + v
        self.w = w
        self.coef_ = w[:-1]
